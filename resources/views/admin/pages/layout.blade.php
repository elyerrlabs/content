            ...
            <section
                ...
                <div class="px-6 pt-4 pb-3 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex flex-wrap items-center gap-1.5">
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'footer']) }}"
                        ...
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'header']) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                        ...
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'schema']) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                        ...
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'favicon']) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                        ...
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'privacy']) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                        ...
                        <a href="{{ route('module.content.admin.layouts.schema', ['layout' => 'fonts']) }}"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                ...
                <!-- Editor form -->
                <form method="POST" action="{{ route('module.content.admin.layouts.update') }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-6 py-4">
                        ...
                        <x-content-editor label="" content="{{ $content }}" preview="{{ false }}"
