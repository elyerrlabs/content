        ...
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex gap-3">
                    <form action="{{ route('module.content.admin.pages.generate-sitemap') }}" method="post">
                        @csrf
                        <button
                    ...
                    @include('Content::admin.pages.form')
                </div>
            </div>

            <!-- Search and Filters -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-6 p-4">
                <form method="GET" action="{{ route('module.content.admin.pages.index') }}"
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="{{ route('module.content.admin.pages.edit', $page->id) }}"
                                                class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 transition-colors"
                                                title="Edit">
                                                <i class="mdi mdi-pencil text-lg"></i>
                                            </a>

                                            @include('Content::admin.pages.delete', [
                                                'page' => $page,
                                            ])
