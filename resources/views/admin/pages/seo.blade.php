        ...
        <section
            ...
            <div class="px-6 pt-4 pb-3 border-b border-gray-100 dark:border-gray-700">
                <div class="flex flex-wrap items-center gap-1.5">
                    <a href="{{ route('module.content.admin.seo.schema', ['layout' => 'login']) }}"
                    ...
                    <a href="{{ route('module.content.admin.seo.schema', ['layout' => 'register']) }}"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                    ...
                    <a href="{{ route('module.content.admin.seo.schema', ['layout' => 'forgot-password']) }}"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
