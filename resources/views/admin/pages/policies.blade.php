        ...
        <section
            ...
            <div class="px-6 pt-4 pb-3 border-b border-gray-100 dark:border-gray-700">
                <div class="flex flex-wrap items-center gap-1.5">
                    <a href="{{ route('module.content.admin.policies.schema', ['layout' => 'terms-and-conditions']) }}"
                    ...
                    <a href="{{ route('module.content.admin.policies.schema', ['layout' => 'policies-of-privacy']) }}"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
                    ...
                    <a href="{{ route('module.content.admin.policies.schema', ['layout' => 'policies-of-cookies']) }}"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150
            ...
            <form method="POST" action="{{ route('module.content.admin.layouts.update') }}" class="space-y-4">
                ...
                <div class="px-6 py-4">
                    ...
                    <x-content-editor label="" content="{{ $content }}" preview="{{ true }}"
