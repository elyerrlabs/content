<x-admin-layout :routes="$routes">
    ...
    <v-slot:main>
        ...
        {{-- Info Alert --}}
        <div class="bg-blue-100 dark:bg-blue-900/40 border border-blue-300 dark:border-blue-700 rounded-lg p-4 my-8">
        ...
        <div class="space-y-6">
            ...
            <div class="p-6 rounded-xl bg-white shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <form action="{{ route('module.content.admin.sitemaps.favicon.update') }}" method="POST"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        ...
                                        <form
                                            action="{{ route('module.content.admin.sitemaps.favicon.delete', ['path' => base64_encode($favicon['path'])]) }}"
                                            method="POST"
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500">
                            ...
                            <br>
                            <a href="{{ route('module.content.admin.layouts.update', ['layout' => 'favicon']) }}"
